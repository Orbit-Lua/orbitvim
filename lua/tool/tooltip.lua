...
---@field diagnostic_summary Tool.LinterDiagnosticSummary?

---@param opts Tool.Tooltip.BuildOpts
---@return string[] lines
...
function M.build_lines(opts)
  ...
  elseif meta.source then
    table.insert(lines, "   source: " .. meta.source .. " ")
  end
