...
---@class Tool.Table.Column
---@field key string
---@field label string
---@field width integer?
---@field grow boolean?

---@class Tool.Table.Row
---@field cells table<string, string>
---@field entry Tool.UIEntry?
---@field icon_cell string?

---@class Tool.Table.RenderOpts
---@field columns Tool.Table.Column[]
---@field rows Tool.Table.Row[]
---@field width integer
---@field indent integer?
---@field separator string?
---@field cell_padding integer?

---@class Tool.Table.CellRange
---@field start_col integer
---@field end_col integer

---@param columns Tool.Table.Column[]
---@param width integer
...
---@return string line, table<string, Tool.Table.CellRange> cell_ranges
...
---@param opts Tool.Table.RenderOpts
---@return string header, string[] lines, table<integer, Tool.UIEntry>
